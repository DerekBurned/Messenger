...
object DatabaseModule {
    ...
    @Provides
    @Singleton
    fun provideMessageDao(db: MessengerDatabase): MessageDao {  
        return db.messageDao()
    }

    @Provides
    @Singleton
    fun provideUserDao(db: MessengerDatabase): UserDao {  
        return db.userDao()
    }

    @Provides
    @Singleton
    fun provideConversationDao(db: MessengerDatabase): ConversationDao {  
        return db.conversationDao()
    }

    @Provides
    @Singleton
    fun provideSyncQueueDao(db: MessengerDatabase): SyncQueueDao {  
